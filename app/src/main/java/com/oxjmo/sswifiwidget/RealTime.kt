...
class RealTime : AppWidgetProvider() {
    ...
    private fun updateAppWidget(
        ...
        val translucent = sharedPreferences.getString("translucent", "否").toString()
        when (translucent) {
            "否" -> views.setInt(R.id.layout, "setBackgroundResource", R.drawable.bg_widget_container)
            "10%" -> views.setInt(R.id.layout, "setBackgroundResource", R.drawable.bg_widget_container_translucent1)
            "30%" -> views.setInt(R.id.layout, "setBackgroundResource", R.drawable.bg_widget_container_translucent2)
            "50%" -> views.setInt(R.id.layout, "setBackgroundResource", R.drawable.bg_widget_container_translucent3)
            "75%" -> views.setInt(R.id.layout, "setBackgroundResource", R.drawable.bg_widget_container_translucent4)
            "90%" -> views.setInt(R.id.layout, "setBackgroundResource", R.drawable.bg_widget_container_translucent5)
        }
